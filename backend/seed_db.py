...
SEED_COMPONENTS = [
    ...
    # ----------------------------------------------------
    {
        ...
        "pins": [
            ...
            {"pin_id": "VP", "name": "GPIO36 / ADC_CH0", "pin_type": "Analog", "voltage": 3.3, "description": "ADC Input Only"},
            {"pin_id": "VN", "name": "GPIO39 / ADC_CH3", "pin_type": "Analog", "voltage": 3.3, "description": "ADC Input Only"},
            {"pin_id": "D34", "name": "GPIO34 / ADC_CH6", "pin_type": "Analog", "voltage": 3.3, "description": "Input Only"},
            {"pin_id": "D35", "name": "GPIO35 / ADC_CH7", "pin_type": "Analog", "voltage": 3.3, "description": "Input Only"},
            {"pin_id": "D32", "name": "GPIO32 / ADC_CH4", "pin_type": "Digital", "voltage": 3.3, "description": "General GPIO"},
            {"pin_id": "D33", "name": "GPIO33 / ADC_CH5", "pin_type": "Digital", "voltage": 3.3, "description": "General GPIO"},
            {"pin_id": "D25", "name": "GPIO25 / DAC_CH1", "pin_type": "Digital", "voltage": 3.3, "description": "DAC / General GPIO"},
            {"pin_id": "D26", "name": "GPIO26 / DAC_CH2", "pin_type": "Digital", "voltage": 3.3, "description": "DAC / General GPIO"},
            {"pin_id": "D27", "name": "GPIO27 / ADC_CH17", "pin_type": "Digital", "voltage": 3.3, "description": "General GPIO"},
            {"pin_id": "D14", "name": "GPIO14 / SPI_CLK", "pin_type": "SPI", "voltage": 3.3, "description": "SPI Clock"},
            {"pin_id": "D12", "name": "GPIO12 / SPI_MISO", "pin_type": "SPI", "voltage": 3.3, "description": "SPI MISO"},
            {"pin_id": "D13", "name": "GPIO13 / SPI_MOSI", "pin_type": "SPI", "voltage": 3.3, "description": "SPI MOSI"},
            {"pin_id": "D23", "name": "GPIO23 / MOSI", "pin_type": "SPI", "voltage": 3.3, "description": "Primary SPI MOSI"},
            ...
            {"pin_id": "TXD", "name": "GPIO1 / UART_TX", "pin_type": "UART", "voltage": 3.3, "description": "Serial Transmit"},
            {"pin_id": "RXD", "name": "GPIO3 / UART_RX", "pin_type": "UART", "voltage": 3.3, "description": "Serial Receive"},
            {"pin_id": "D19", "name": "GPIO19 / MISO", "pin_type": "SPI", "voltage": 3.3, "description": "Primary SPI MISO"},
            {"pin_id": "D18", "name": "GPIO18 / SCK", "pin_type": "SPI", "voltage": 3.3, "description": "Primary SPI Clock"},
            {"pin_id": "D5", "name": "GPIO5 / SS", "pin_type": "SPI", "voltage": 3.3, "description": "Primary SPI Chip Select"},
    ...
    },
    {
        ...
        "pins": [
            ...
            {"pin_id": "A0", "name": "Analog 0", "pin_type": "Analog", "voltage": 5.0, "description": "Analog Input 0"},
            {"pin_id": "A1", "name": "Analog 1", "pin_type": "Analog", "voltage": 5.0, "description": "Analog Input 1"},
            {"pin_id": "A2", "name": "Analog 2", "pin_type": "Analog", "voltage": 5.0, "description": "Analog Input 2"},
            {"pin_id": "A3", "name": "Analog 3", "pin_type": "Analog", "voltage": 5.0, "description": "Analog Input 3"},
            {"pin_id": "A4", "name": "Analog 4 / I2C_SDA", "pin_type": "I2C", "voltage": 5.0, "description": "I2C SDA / Analog Input 4"},
            {"pin_id": "A5", "name": "Analog 5 / I2C_SCL", "pin_type": "I2C", "voltage": 5.0, "description": "I2C SCL / Analog Input 5"},
            {"pin_id": "D2", "name": "Digital 2 / INT0", "pin_type": "Digital", "voltage": 5.0, "description": "GPIO / Interrupt 0"},
            {"pin_id": "D3", "name": "Digital 3 / PWM", "pin_type": "PWM", "voltage": 5.0, "description": "GPIO / PWM / Interrupt 1"},
            {"pin_id": "D4", "name": "Digital 4", "pin_type": "Digital", "voltage": 5.0, "description": "GPIO"},
            {"pin_id": "D5", "name": "Digital 5 / PWM", "pin_type": "PWM", "voltage": 5.0, "description": "GPIO / PWM"},
            {"pin_id": "D6", "name": "Digital 6 / PWM", "pin_type": "PWM", "voltage": 5.0, "description": "GPIO / PWM"},
            {"pin_id": "D7", "name": "Digital 7", "pin_type": "Digital", "voltage": 5.0, "description": "GPIO"},
            {"pin_id": "D8", "name": "Digital 8", "pin_type": "Digital", "voltage": 5.0, "description": "GPIO"},
            {"pin_id": "D9", "name": "Digital 9 / PWM", "pin_type": "PWM", "voltage": 5.0, "description": "GPIO / PWM"},
            {"pin_id": "D10", "name": "Digital 10 / SPI_SS", "pin_type": "SPI", "voltage": 5.0, "description": "SPI SS / PWM"},
            {"pin_id": "D11", "name": "Digital 11 / SPI_MOSI", "pin_type": "SPI", "voltage": 5.0, "description": "SPI MOSI / PWM"},
            {"pin_id": "D12", "name": "Digital 12 / SPI_MISO", "pin_type": "SPI", "voltage": 5.0, "description": "SPI MISO"},
            {"pin_id": "D13", "name": "Digital 13 / Built-in LED", "pin_type": "Digital", "voltage": 5.0, "description": "SPI Clock / Built-in LED"}
        ],
    ...
    # ----------------------------------------------------
    {
        ...
        "price": 2.80,
        "sourcing_url": "https://www.sparkfun.com/datasheets/Sensors/Temperature/DHT22.pdf",
        "pins": [
    ...
    },
    {
        ...
        "category": "Sensor",
        "description": "Ultrasonic rangefinder measuring distance from 2cm to 400cm. Operates primarily at 5V.",
        "price": 1.50,
        "sourcing_url": "https://cdn.sparkfun.com/datasheets/Sensors/Proximity/HCSR04.pdf",
        "pins": [
            {"pin_id": "VCC", "name": "5V Power Supply", "pin_type": "Power", "voltage": 5.0, "description": "Requires exactly 5.0V nominal"},
            {"pin_id": "TRIG", "name": "Trigger Input", "pin_type": "Digital", "voltage": 5.0, "description": "10us pulse triggers measurement"},
            {"pin_id": "ECHO", "name": "Echo Output", "pin_type": "Digital", "voltage": 5.0, "description": "Pulse width matches roundtrip time"},
            {"pin_id": "GND", "name": "Ground", "pin_type": "Ground", "voltage": 0.0, "description": "Ground"}
        ],
        "use_cases": ["robotics", "obstacle-avoidance", "distance-sensing", "fluid-level", "security"]
    },
    {
        "part_number": "BMP280",
        ...
        "price": 1.80,
        "sourcing_url": "https://www.bosch-sensortec.com/products/environmental-sensors/pressure-sensors/bmp280/",
        "pins": [
    ...
    },
    {
        ...
        "category": "Sensor",
        "description": "Inertial Measurement Unit (IMU) combining 3-axis accelerometer, 3-axis gyro, and internal digital motion processor.",
        "price": 2.20,
        "sourcing_url": "https://invensense.tdk.com/products/motion-tracking/6-axis/mpu-6050/",
        "pins": [
            {"pin_id": "VCC", "name": "VCC Power (3.3V or 5V)", "pin_type": "Power", "voltage": 3.3, "description": "Includes onboard regulator"},
            {"pin_id": "GND", "name": "Ground", "pin_type": "Ground", "voltage": 0.0, "description": "Ground"},
            {"pin_id": "SCL", "name": "I2C Serial Clock", "pin_type": "I2C", "voltage": 3.3, "description": "I2C SCL Line"},
            {"pin_id": "SDA", "name": "I2C Serial Data", "pin_type": "I2C", "voltage": 3.3, "description": "I2C SDA Line"},
            {"pin_id": "XDA", "name": "Aux I2C Data", "pin_type": "I2C", "voltage": 3.3, "description": "For connecting external compass"},
            {"pin_id": "XCL", "name": "Aux I2C Clock", "pin_type": "I2C", "voltage": 3.3, "description": "For connecting external compass"},
            {"pin_id": "AD0", "name": "I2C Address Select", "pin_type": "Digital", "voltage": 3.3, "description": "LSB of I2C address (low=0x68, high=0x69)"},
            {"pin_id": "INT", "name": "Interrupt Out", "pin_type": "Digital", "voltage": 3.3, "description": "Motion interrupt output pin"}
        ],
        "use_cases": ["robotics", "balancing-robot", "vr-headset", "drone-stability", "gesture-control", "motion-tracking"]
    },
    ...
    },
    {
        ...
        "price": 1.20,
        "sourcing_url": "https://components101.com/switches/5v-single-channel-relay-module-pinout-features-datasheet",
        "pins": [
    ...
    # ----------------------------------------------------
    {
        ...
        "price": 2.50,
        "sourcing_url": "https://components101.com/displays/096-inch-oled-display-module-pinout-datasheet",
        "pins": [
    ...
    # ----------------------------------------------------
    {
        ...
        "price": 5.50,
        "sourcing_url": "https://components101.com/batteries/37v-lipo-battery-specification-datasheet",
        "pins": [
    ...
    },
    {
        ...
        "category": "Power",
        "description": "Plugs into any 5V 1A or 2A USB wall block, outputting safe 5V power reference over micro-USB/Type-C or pin leads.",
        "price": 1.50,
        "sourcing_url": "https://en.wikipedia.org/wiki/USB",
        "pins": [
            {"pin_id": "5V", "name": "5V Power Line", "pin_type": "Power", "voltage": 5.0, "description": "5.0V Regulated Rail"},
            {"pin_id": "GND", "name": "Ground", "pin_type": "Ground", "voltage": 0.0, "description": "Ground"}
        ],
        "use_cases": ["stationary-power", "smart-home-hub", "sensors", "relay-controller"]
    },
    {
        ...
        "price": 0.10,
        "sourcing_url": "https://components101.com/diodes/5mm-red-led-pinout-specifications",
        "pins": [
    ...
    },
    {
        ...
        "category": "Passives",
        "description": "Standard resistance for pull-up and pull-down resistor applications, keeping floating lines tied to clean VCC/GND.",
        "price": 0.05,
        "sourcing_url": "https://components101.com/resistors/resistor-color-code",
        "pins": [
            {"pin_id": "1", "name": "Lead 1", "pin_type": "Passive", "voltage": None, "description": "Bidirectional passive pin"},
        ...
        "use_cases": ["pull-up", "pull-down", "button-debouncing", "reset-line"]
    }
]
